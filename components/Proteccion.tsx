...
const Proteccion = () => {
  return (
    <section className='flexCenter flex-col relative pb-28 overflow-y-auto scroll-smooth' id='Proteccion'>
      <div className="proteccion">
        ...
        <div className="flex w-full flex-1 flex-col text-center items-center justify-center gap-3">
          ...
          <div className="flex flex-col w-full gap-3 sm:flex-row items-center justify-center ">
